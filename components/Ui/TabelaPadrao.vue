                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="space-x-1 items-center flex ml-1">
                    <button
                      ...
                      <svg v-if="colunaOrdenada !== cab.valor || tipoOrdenacao !== 'DESC'"
                           xmlns="http://www.w3.org/2000/svg"
                           viewBox="0 0 24 24"
                           fill="currentColor"
                           class="w-5 h-5 hover:fill-blue-600 cursor-pointer"
                           :class="{'fill-blue-400' : tipoOrdenacao === 'ASC'&& colunaOrdenada === cab.valor}">
                        <path
                          fill-rule="evenodd"
                      ...
                      <svg
                        ...
                        fill="currentColor"
                        class="w-5 h-5 hover:fill-blue-600 cursor-pointer"
                        :class="{'fill-blue-400' : tipoOrdenacao === 'DESC' && colunaOrdenada === cab.valor }"
                      >
                        <path
                          fill-rule="evenodd"
