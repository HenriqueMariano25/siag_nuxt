<template>
	<div>
		<BaseDialog
			titulo="Importar equipe planejamento"
			@cancelar="cancelar()">
					...
					<div class="flex gap-2">
						...
						<div class="flex self-end">
							<BotaoPadrao
								...
								@clique="importarEquipePlanejamento()"
								:disabled="!arquivo">
								<img
...
<script>
	...
	export default {
		...
		methods: {
			...
			async importarEquipePlanejamento() {
				let arquivo = this.arquivo
				let formData = new FormData()
				formData.append("file", arquivo)
				let resp = await this.$axios.$post("/planejamento/equipe_planejamento/importar", formData, {
					headers: {
