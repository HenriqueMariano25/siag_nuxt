		...
		<BaseDialog
			...
			<template v-slot:corpo>
				<div
					...
					<div class="flex flex-col pagina-1 border border-black p-1 print:h-full">
						<div class="flex">
							<img
						...
						<div
							...
							class="w-full flex justify-end print:mt-[360px]">
						...
						<div
							...
							<span>{{ recado.substr(0, 500) }}{{ recado.length > 500 ? "..." : "" }}</span>
						</div>
						<div
							class="flex border border-black items-center p-1 print:mt-[330px]"
					...
					<div class="flex flex-col pagina-2 border border-black print:h-full break-before-page">
						...
						<div class="text-center flex flex-col mt-[25px] justify-center w-full">
							<div
					...
					<div v-for="rep in parseInt(repeticaoValidada)">
						<div class="flex flex-col pagina-3 border border-black print:h-full break-before-page">
							<div class="border-b border-black flex items-center text-center">
								<div class="p-2 border-r border-black flex">
									<img
										src="@/assets/img/logoagcnovo.png"
							...
							<div class="flex items-center border-b border-black">
								...
								<div class="border-l border-black grow divide-y divide-black">
									<div class="flex gap-3 items-center py-0.5 border-black px-2">
										<img
									...
									<div class="flex gap-3 items-center py-0.5 border-b border-black px-2">
										<img
							...
							<div class="text-center border-b border-black">
								<span style="font-size: 20px">
									<strong> Reconheço ter participado do Diálogo Diário de Segurança - DDS </strong>
								</span>
							</div>
							<div>
								<table class="w-full tabela">
						...
						<div class="flex flex-col pagina-4 border border-black print:h-full break-before-page">
							<div class="border-b border-black flex items-center text-center">
								<div class="p-2 border-r border-black flex">
									<img
										src="@/assets/img/logoagcnovo.png"
							...
							<div class="grid grid-cols-12 divide-x divide-black px-1 border-b border-black">
								...
								<div class="col-span-4 flex">
									<div class="mr-[90px]">
										<span class="ml-1"><strong>AR N°:</strong></span>
									</div>
									<div>
            ...
            <template v-if="funcionarios.length > 30">
              <div class="flex flex-col pagina-3 border border-black print:h-full break-before-page">
                <div class="border-b border-black flex items-center text-center">
                  <div class="p-2 border-r border-black flex">
                    <img
                ...
                <div>
                  <table class="w-full tabela">
                    ...
                    <tr
                      v-for="(funcionario, index) in funcionarios.slice(30, 60)"
                      :key="funcionario.chapa"
                      style="height: 10px; font-size: 12px"
                      class="font-normal">
                      <td
                    ...
                    <tr
                      v-for="index in restanteCamposSegunda"
                      :key="index"
                      style="font-size: 12px"
                      class="font-normal">
                      <td
