		...
		<template v-slot:corpo>
			<div
				...
				<div
					...
					v-if="psp">
          <div class="border-b-2 border-black hidden print:flex">
            <span class="text-3xl"><strong>Gestão de Viagem</strong></span>
					...
					<span> <strong>Transporte: </strong>{{ psp.transporte }} </span>
					...
					<div class="grid grid-cols-2 w-full divide-x divide-gray-400" v-if="psp.aprovador_gaf && psp.aprovacao_gaf">
						<span class="grow">
							<strong>Aprovador GAF: </strong>
          ...
          <div class="grid grid-cols-2 w-full divide-x divide-gray-400" v-if="psp.aprovador_rh && psp.aprovacao_rh">
						<span class="grow">
							<strong>Aprovador RH: </strong>
          ...
          <div class="grid grid-cols-2 w-full divide-x divide-gray-400" v-if="psp.aprovador_coordenador && psp.aprovacao_coordenador">
						<span class="grow">
							<strong>Aprovador Coordenador: </strong>
          ...
          <div class="grid grid-cols-2 w-full divide-x divide-gray-400"
               v-if="psp.aprovador_gerente_area && psp.aprovacao_gerente_area">
						<span class="grow">
							<strong>Aprovador Gerente Área: </strong>
