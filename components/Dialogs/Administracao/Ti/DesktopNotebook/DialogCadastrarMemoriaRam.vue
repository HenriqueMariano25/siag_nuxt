  ...
  <div>
    <BaseDialog
      ...
      <template v-slot:corpo>
        <div class="px-2">
          <AppFormInput id="memoria_ram" type="text" label="Memória Ram" v-model="nome" placeholder="Ex: 8GB" />
        </div>
      </template>
      <template v-slot:rodape-btn-direito>
        <div class="flex items-center gap-2">
          <span class="text-red-400 text-bold" v-if="jaCriado">Já existe essa memória ram!</span>
          <BotaoPadrao texto="salvar" @clique="cadastrarMemoriaRam()">
