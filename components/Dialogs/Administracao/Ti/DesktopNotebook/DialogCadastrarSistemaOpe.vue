  ...
  <div>
    <BaseDialog
      ...
      <template v-slot:corpo>
        <div class="px-2">
          <AppFormInput id="disco" type="text" label="Disco" v-model="nome" placeholder="Ex: WINDOWS 11 PRO" uppercase/>
        </div>
      </template>
      <template v-slot:rodape-btn-direito>
        <div class="flex items-center gap-2">
          <span class="text-red-400 text-bold" v-if="jaCriado">Já existe esse sistema operacional!</span>
          <BotaoPadrao texto="salvar" @clique="cadastrarSistemaOpe()">
