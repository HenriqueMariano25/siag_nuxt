  ...
  <div>
    <BaseDialog
      ...
      <template v-slot:corpo>
        <div class="px-2">
          <AppFormInput id="processador" type="text" label="Processador" v-model="nome" placeholder="Ex: Core i3 7100T 3.90Ghz" />
        </div>
      </template>
      <template v-slot:rodape-btn-direito>
        <div class="flex items-center gap-2">
          <span class="text-red-400 text-bold" v-if="jaCriado">Já existe esse processador!</span>
          <BotaoPadrao texto="salvar" @clique="cadastrarProcessador()">
