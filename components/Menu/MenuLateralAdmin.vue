<template>
  <div class="grid h-full relative text-white bg-gray-800 z-10 content-between"
    ...
    <div class="flex flex-col divide-y divide-white/[.30] border-b border-b-white/[0.30]">
      <div class="flex content-center p-1 ">
        ...
        <h1 class="font-bold text-3xl self-center ml-6" v-if="menuAberto">ADMIN</h1>
      </div>
      <div>
        <div class="p-1">
          <NuxtLink to="/admin">
        ...
        <div class="p-1">
          <NuxtLink to="/admin/usuarios">
            <button class="items-center flex h-11 hover:bg-white/[.30] w-full p-1 rounded text-sm">
              <img src="@/assets/icons/account-circle-w.svg" alt="close" class="w-8 h-8"/>
              <span class="ml-2" v-if="menuAberto">Usuários</span>
            </button>
          </NuxtLink>
          <NuxtLink to="/admin/permissoes">
            <button class="items-center flex h-11 hover:bg-white/[.30] w-full p-1 rounded text-sm">
              <img src="@/assets/icons/unlock-padlock-w.svg" alt="close" class="w-7 h-7"/>
              <span class="ml-2" v-if="menuAberto">Permissões</span>
            </button>
          </NuxtLink>
        </div>
