    ...
    <div class="flex w-full bg-primaria-900 h-14 flex text-white">
      <button
        ...
        v-if="
					...
					$store.state.usuario.usuario.permissoes.includes('aprovar_ss_controle')
				"
      ...
      <button
        ...
        v-if="
					$store.state.usuario.usuario &&
					$store.state.usuario.usuario.permissoes.includes('aprovar_ss_gerente_area')
				"
      ...
      <button
        ...
        v-if="
					$store.state.usuario.usuario &&
					$store.state.usuario.usuario.permissoes.includes('aprovar_ss_site_manager')
				"
